...
//         if (filter) {
//           setFilter((prevData) => [...prevData, ...res.data.queryResult]);
//         } else {
...
//           console.log(res);
//           if (filter) {
//             setFilter((prevData) => [...prevData, ...res.data.savedEvents]);
//           } else {
...
//   const handleScroll = (mode, category, filterdate, exclusive, searchKey) => {
...
//   useEffect(() => {
//     // Call handleScroll with the mode variable
//     handleScroll(mode, category, filterdate, exclusive, searchKey);

//     // Set up the event listener inside the useEffect hook
